#!/usr/bin/env python3
"""
سكريبت مباشر لحل مشكلة توكن التلغرام وإعادة تشغيل البوت
"""
import os
import sys
import time
...
# التوكن الجديد - تم تعيينه مباشرة
...
def main():
    ...
    # استخدام التوكن الجديد المحدد مسبقاً
    token = NEW_TOKEN
    
    # 1. التحقق من صحة التوكن
    if not verify_token(token):
        print(f"{RED}❌ فشل التحقق من التوكن. توقف العملية.{RESET}")
        return
